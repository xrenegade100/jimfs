...
public class Jimfs_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.google.common.jimfs.Jimfs"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Jimfs_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.google.common.jimfs.JimfsFileSystems$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Jimfs_ESTest_scaffolding.class.getClassLoader()); 
